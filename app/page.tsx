...
export default function VibeSpyFinal() {
  ...
  const handleAnalyze = async () => {
    ...
    } catch (e) { alert("Server Busy. Results will be in Archive."); }
    setLoading(false);
  };
    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 p-8">
      <div className="max-w-7xl mx-auto flex justify-between items-center mb-16">
        ...
        <div className="flex gap-2">
          ...
          <button onClick={handleAnalyze} disabled={loading} className="bg-blue-600 px-8 py-2 rounded-xl font-bold uppercase text-xs active:scale-95 transition-all">
      ...
      <div className="max-w-7xl mx-auto space-y-20">
        {results.map((res, i) => (
          <div key={i} className="bg-slate-900/50 border border-slate-800 rounded-[3rem] p-10 shadow-2xl animate-in fade-in slide-in-from-bottom-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10">
              ...
              <div className="lg:col-span-7 grid grid-cols-2 sm:grid-cols-3 gap-4">
                {res.creatives.map((ad: any) => (ad.video || ad.thumbnail) && (
