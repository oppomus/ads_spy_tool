  ...
  return (
    <div className="min-h-screen bg-[#020617] text-slate-100 p-8 font-sans">
      ...
      <div className="max-w-7xl mx-auto space-y-16">
        {results.map((res, i) => (
          <div key={i} className="bg-slate-900/50 border border-slate-800 rounded-[3rem] p-10 shadow-2xl">
            <h2 className="text-5xl font-black mb-8 uppercase italic">{res.brand}</h2>
